...
const Login = (props) => {
  ...
  return (
    <PopupWithForm name="Login" title="Войти" buttonText="Войти" linkText="Зарегистрироваться" isOpen={props.isOpen} onClose={props.onClose} isFormValid={isFormValid} formSwitcher={props.formSwitcher} submit={formSubmit}>
